  ...
  <section className="text-slate-200 ">
    <div className="max-w-xl mx-auto px-8 pt-8 pb-8">
      ...
      <nav className="flex flex-row gap-4 align-middle">
        <Link to="https://linkedin.com/in/scostadavid" className="text-content hover:text-cta self-center hover:scale-105" target="_blank">
        ...
        <Link to="https://github.com/scostadavid" className="text-content hover:text-cta text-lg self-center hover:scale-105" target="_blank">
        ...
        <Link to="https://x.com/scostadavid" className="text-content hover:text-cta text-lg self-center hover:scale-105" target="_blank">
